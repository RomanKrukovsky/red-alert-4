...
| `SCREENSHOTS` | 24 | Легаси-источник. Только композиция там, где ремастер намеренно не дублировал. Содержит Command & Conquer, Red Alert 4 и советскую символику — в интерфейс не переносится |
