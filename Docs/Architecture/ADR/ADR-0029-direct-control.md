# ADR-0029: Authoritative Direct Vehicle Control

> **Renumbered 2026-08-20**: this document was ADR-0011, a number it shared with
> ADR-0011 (ADR Series Consolidation) — the exact defect that consolidation ADR
> was written to prevent. NEXT_ACTIONS P-3 prescribed ADR-0028, but ADR-0028 was
> taken by the telemetry work in the meantime, so this is ADR-0029. The old path
> `ADR-0011-DirectControl.md` remains as a redirect stub. Citations of
> "ADR-0011 (DirectControl)" in older documents mean this file.
