...
// RA4Simulation is deliberately engine-light: it depends on Core only for the build system and
...
public class RA4Simulation : ModuleRules
{
	public RA4Simulation(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "RA4Core", "RA4Content", "RA4Navigation", "RA4FogOfWar", "RA4Recon" });
